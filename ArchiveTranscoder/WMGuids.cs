...
{
	/// <summary>
	/// A subset of WMFSDK guids, and code to support conversions to and from System.Guid.
	/// </summary>
	class WMGuids
	{
        ...
        //Compressed types from wmcodecconst.h
        public static Guid WMCMEDIASUBTYPE_WMV3 = new Guid("33564D57-0000-0010-8000-00AA00389B71");
        public static Guid WMCMEDIASUBTYPE_WMV2 = new Guid("32564D57-0000-0010-8000-00AA00389B71");
        public static Guid WMCMEDIASUBTYPE_WVP2 = new Guid("32505657-0000-0010-8000-00AA00389B71");

        public static uint WM_SF_CLEANPOINT = 0x00000001;
        public static uint WM_SF_DISCONTINUITY = 0x00000002;
