...
namespace CP3Manager {
    ...
    class CP3StateCache {
        ...
        private Dictionary<Guid, string> deckTitles;        //Map of deck names we encounter
        ...
        public CP3StateCache() {
            ...
            this.deckTitles = new Dictionary<Guid, string>();
        }

        /// <summary>
        /// Return deck and slide titles
        /// </summary>
        /// <returns></returns>
        internal string GetSlideTitles() {
            StringBuilder sb = new StringBuilder();
            foreach (Guid deckId in this.deckTitles.Keys) {
                sb.Append("<DeckTitle DeckGuid=\"" + deckId.ToString() + "\" Text=\"" + TableOfContents.FixTitle(this.deckTitles[deckId]) + "\"/>  ");
            }
            sb.Append(toc.GetSlideTitles());
            return sb.ToString();
        }
        ...
        /// <summary>
        /// Grab the deck name and background color from this message.
        ...
        internal object UpdateDeckInformation(CP3Msgs.DeckInformationMessage dim) {
            //Update deck titles list
            if (!this.deckTitles.ContainsKey((Guid)dim.TargetId)) {
                this.deckTitles.Add((Guid)dim.TargetId, dim.HumanName);
            }
